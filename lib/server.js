...
(function() {
    ...
    function initialize_database(settings, callback) {
        var url = util.format(
                ...
                settings.NAME);
        callback(!(settings.NAME !== '' && settings.HOST !== ''), url);
    }
    ...
    module.exports = function() {
        ...
        return {
            ...
            parse: function(obj, use, callback) {
                ...
                this.database = raw_settings.DATABASES[this.database_name];
            ...
            run_server: function(port, error_callback) {
                ...
                validator.validate_routes(app, express,
                    that.url_patterns, function(route_error) {
            ...
            db_connect: function(error_callback) {
                ...
                initialize_database(that.database, function(err, db_url) {
                    ...
                    mongoose.connection.on('error', function(error) {
                        error_callback("Connection to '" + db_url + "' FAILED.\n" + error);
                    });
